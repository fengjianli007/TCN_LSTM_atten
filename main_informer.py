...
parser.add_argument('--data_path', type=str, default='select_feature_DF.csv', help='data file')    
parser.add_argument('--features', type=str, default='M', help='forecasting task, options:[M, S, MS]; M:multivariate predict multivariate, S:univariate predict univariate, MS:multivariate predict univariate')
parser.add_argument('--target', type=str, default='Total_Area', help='target feature in S or MS task')
...
parser.add_argument('--CSP', action='store_true', help='whether to use CSPAttention, default=False', default=True)
parser.add_argument('--dilated', action='store_true', help='whether to use dilated causal convolution in encoder, default=False', default=True)
parser.add_argument('--passthrough', action='store_true', help='whether to use passthrough mechanism in encoder, default=False', default=True)
